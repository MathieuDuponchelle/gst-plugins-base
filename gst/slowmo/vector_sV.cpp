...
void Vector_sV::toQPointF(QPointF *ret) const
{
  ret->x = (int) x();
  ret->y = (int) y();
}
...
void Vector_sV::add(Vector_sV factor, Vector_sV *res)
{
  res->rx() = m_x + factor.m_x;
  res->ry() = m_y + factor.m_y;
}

void Vector_sV::sub(Vector_sV factor, Vector_sV *res)
{
  res->rx() = m_x - factor.m_x;
  res->ry() = m_y - factor.m_y;
}

void Vector_sV::mul(float factor, Vector_sV *res)
{
  res->rx() = m_x * factor;
  res->ry() = m_y * factor;
}
