...
gst_video_meta_api_get_type (void)
{
  ...
  static const gchar *tags[] =
      { GST_VIDEO_METADATA, GST_MEMORY_METADATA, GST_VIDEO_COLORSPACE_METADATA,
    GST_VIDEO_SIZE_METADATA, NULL
  };
...
{
  static volatile GType type = 0;
  static const gchar *tags[] = { GST_VIDEO_METADATA, GST_VIDEO_SIZE_METADATA,
    GST_VIDEO_ORIENTATION_METADATA, NULL
  };
...
gst_video_gl_texture_upload_meta_api_get_type (void)
{
  static volatile GType type = 0;
  static const gchar *tags[] =
      { GST_VIDEO_METADATA, GST_MEMORY_METADATA, NULL };
...
gst_video_region_of_interest_meta_api_get_type (void)
{
  ...
  static const gchar *tags[] =
      { GST_VIDEO_METADATA, GST_VIDEO_ORIENTATION_METADATA,
    GST_VIDEO_SIZE_METADATA, NULL
  };
